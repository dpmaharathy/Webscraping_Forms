...
output_dir = 'insurance_claim_forms'
os.makedirs(output_dir, exist_ok=True)

# Open the CSV file and read the image URLs
csv_file_path = r'C:\Users\HP\Downloads\Forms_Scraping\Insurance_claim_forms.csv'
with open(csv_file_path, encoding='utf-8') as csvfile:
    ...
    for row in csv_reader:
        ...
        try:
            response = requests.get(image_url, stream=True)  # Stream the response content
            ...
            # Write the image content to a file using streaming
